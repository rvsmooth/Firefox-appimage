...
Name[zh_CN]=新建窗口
Name[zh_TW]=開新視窗
Exec=/home/$(whoami)/.local/bin/firefox --new-window %u
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/home/$(whoami)/.local/bin/firefox --private-window %u"
...
__download_assets() {
  DL_URL="https://github.com/rvsmooth/Firefox-appimage/releases/download/continuous-stable"
  URL="${DL_URL}/$1"
  wget -q --show-progress -nc --wait=2 --random-wait $URL
}
__compare_v() {
  version1="$UPSTREAM_VERSION"
  version2="$LOCAL_VERSION"
  echo "local version is $version2"
